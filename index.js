...
// Product create... bulk product upload added...
app.post('/create-product', upload.array('images', 5), createProductController);
app.post('/bulk/create-product',upload.single('file'), bulkCreateProductController);
...
app.post('/search', getSearchDataController)
